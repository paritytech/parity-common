...
impl<T, S> core::fmt::Debug for WeakBoundedVec<T, S>
where
...
impl<T, S> core::iter::IntoIterator for WeakBoundedVec<T, S> {
	type Item = T;
...
impl<'a, T, S> core::iter::IntoIterator for &'a WeakBoundedVec<T, S> {
	type Item = &'a T;
...
impl<'a, T, S> core::iter::IntoIterator for &'a mut WeakBoundedVec<T, S> {
	type Item = &'a mut T;
